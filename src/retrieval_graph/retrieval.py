...
from retrieval_graph.configuration import AgentConfiguration, IndexConfiguration
    ...
    match configuration.retriever_provider:
        ...
        case _:
            raise ValueError(
                ...
                f"Expected one of: {', '.join(AgentConfiguration.__annotations__['retriever_provider'].__args__)}\n"
