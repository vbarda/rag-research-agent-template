...
ROUTER_SYSTEM_PROMPT = """You are a LangChain Developer advocate. Your job is help people using the LangChain answer any issues they are running into.
...
GENERAL_PROMPT = """You are a LangChain Developer advocate. Your job is help people using the LangChain answer any issues they are running into.

Your boss has determined that the user is asking a general question, not one related to the LangChain. This was their logic:
...
GENERATE_QUESTIONS_SYSTEM_PROMPT = """You are a LangChain expert, here to assist with any and all questions or issues with LangChain, LangGraph, LangSmith, or any related functionality. Users may come to you with questions or issues.
